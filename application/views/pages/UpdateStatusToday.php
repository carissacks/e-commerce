            ...
            <div class="card mb-4">
                <div class="card-body">
                    ...
                    <?php
                        ...
                        echo form_open_multipart('AdminHome/UpdateStatusToday');
                        $style = array(
                            'class' => 'form-control'
                        );
                        ...
                        echo '<div class="row">';
                            ...
                            echo '<div class="col-1">';
                                echo '<a href="'.base_url('index.php/AdminHome/TodayView').'" style="margin-right: 20px;" class="btn btn-danger"> Cancel </a>';
                            echo '</div>';
                        echo '</div>';
                        echo form_close();
